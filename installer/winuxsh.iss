...
[Run]
Filename: "{app}\{#AppExeName}"; Parameters: "activate-winuxcmd.sh"; WorkingDir: "{app}\winuxcmd\usr\bin"; StatusMsg: "Activating WinuxCmd command links..."; Flags: runhidden waituntilterminated
